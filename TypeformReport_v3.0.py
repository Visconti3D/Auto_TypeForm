...
jornais = ['H1', 'BDDF', 'BDBR', 'DF1', 'GE', 'JH', 'DF2',
           'JN', 'JG', 'GNEWS', 'MH16', 'MH18', 'J10', 'ED16', 'ED18', 'GCO']
...
#CARREGANDO A PARTIR DA DATA ATUAL
...
## CARREGANDO A PARTIR DO MÊS E DIA ESCOLHIDOS

year = '22'
month = '03'
data = year + '-' + month 

CSV_filter = r"S:\\A R Q U I V O S\\FERRAMENTAS\\GitRepository\\Auto_Typeform\\CSV_FINAL\\relatorios_" + data
...
## CRIANDO UM CSV CONSOLIDADO DO MÊS

Mounth_CSV = r"S:\\A R Q U I V O S\\FERRAMENTAS\\GitRepository\\Auto_Typeform\\CSV_FINAL\\bkp\\CSV_CONSOLIDADO_" + data + ".csv"
TOTAL_CSV = df.to_csv(Mounth_CSV)
...
totalGeral = 'PRODUÇÃO TOTAL DE ARTES CDESIGN BSB = ' + str(df_Finalmes['TOTAL GERAL'].iloc[-1])            #Texto do Subtítulo com a contagem total de artes

r1.add_subplot(4,1,1)
r1.text(3, 8, 'boxed italics text in data coords', style='italic', bbox={'facecolor': 'red', 'alpha': 0.5, 'pad': 10})
r1.suptitle(totalGeral, fontsize=16, style='normal')
...
Report01 = r"S:\\A R Q U I V O S\\FERRAMENTAS\\GitRepository\\Auto_Typeform\\RELATORIOS_FINAIS\\RELATÓRIO 01_" + data + ".png"
plt.tight_layout()
...
##
##
##Report02 = r"S:\\A R Q U I V O S\\FERRAMENTAS\\GitRepository\\Auto_Typeform\\RELATORIOS_FINAIS\\RELATÓRIO 02_" + data + ".png"
##plt.tight_layout()
...
##
##
##Report03 = r"S:\\A R Q U I V O S\\FERRAMENTAS\\GitRepository\\Auto_Typeform\\RELATORIOS_FINAIS\\RELATÓRIO 03_" + data + ".png"
##plt.tight_layout()
